      ...
      body: Padding(
          ...
          child: ListView(children: [
            Padding(
                ...
                weatherRow('Percieved: ', result.percieved.toStringAsFixed(2)), //Becas double
                weatherRow('Pressure: ', result.pressure.toString()), //Becas integer
                weatherRow('Humidity: ', result.humidity.toString()), //Becas integer
